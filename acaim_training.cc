...
int main()
{
	...
	//==========================================================//
   {
		...
		while (1)
		{
			...
			for (unsigned year = 2011; year <= 2017; year++)
			{
				...
				for (auto it = page_posts_published.begin(); it != page_posts_published.end(); it++)
				{
					...
					{
						if ((year == 2006) && (it2->first >= 1167606000)) break;
						else if ((year == 2007) && (it2->first >= 1199142000)) break;
						else if ((year == 2008) && (it2->first >= 1230764400)) break;
						else if ((year == 2009) && (it2->first >= 1262300400)) break;
						else if ((year == 2010) && (it2->first >= 1293836400)) break;
						else if ((year == 2011) && (it2->first >= 1325372400)) break;
						else if ((year == 2012) && (it2->first >= 1356994800)) break;
					   	...
					   	current_user = *it3;  // get 'current_user' that liked '*it2'
							...
							for (auto it4 = user_features[current_user].begin(); it4 != user_features[current_user].end(); it4++) {
								if (it4->first == it->first) {
									if (year == 2006) it4->second = it4->second + 1;
									else if (year == 2007) it4->second = it4->second + 2;
									else if (year == 2008) it4->second = it4->second + 3;
									else if (year == 2009) it4->second = it4->second + 4;
									else if (year == 2010) it4->second = it4->second + 5;
									else if (year == 2011) it4->second = it4->second + 6;
									else if (year == 2012) it4->second = it4->second + 7;
									else if (year == 2013) it4->second = it4->second + 8;
									else if (year == 2014) it4->second = it4->second + 9;
									else if (year == 2015) it4->second = it4->second + 10;
									else if (year == 2016) it4->second = it4->second + 11;
									else if (year == 2017) it4->second = it4->second + 12;
									feature_exist = 1;  break;
								}
							}
							if (!feature_exist) {
								if (year == 2006) user_features[current_user].push_back(make_pair(it->first, 1));
								else if (year == 2007) user_features[current_user].push_back(make_pair(it->first, 2));
								else if (year == 2008) user_features[current_user].push_back(make_pair(it->first, 3));
								else if (year == 2009) user_features[current_user].push_back(make_pair(it->first, 4));
								else if (year == 2010) user_features[current_user].push_back(make_pair(it->first, 5));
								else if (year == 2011) user_features[current_user].push_back(make_pair(it->first, 6));
								else if (year == 2012) user_features[current_user].push_back(make_pair(it->first, 7));
								else if (year == 2013) user_features[current_user].push_back(make_pair(it->first, 8));
								else if (year == 2014) user_features[current_user].push_back(make_pair(it->first, 9));
								else if (year == 2015) user_features[current_user].push_back(make_pair(it->first, 10));
								else if (year == 2016) user_features[current_user].push_back(make_pair(it->first, 11));
								else if (year == 2017) user_features[current_user].push_back(make_pair(it->first, 12));
							}
